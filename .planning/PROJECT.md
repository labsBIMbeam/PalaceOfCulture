...
The approved ingest synthesized 34 documents (9 ADRs, 11 specifications, 6 PRDs, and 8 supporting documents) with 0 blockers, 0 warnings, and 7 informational auto-resolutions. Eight ADRs are locked; ADR-0006 remains proposed and is superseded only where ADR-0009 moves the first public realtime target from HQ to `street`.
